...
export const cubicBezierYForX = (x: number, a: Vector, b: Vector, c: Vector, d: Vector, precision = 2) => {
...
export const controlPoint = (current: Vector, previous: Vector, next: Vector, reverse: boolean, smoothing: number) => {
...
export const curveLines = (points: Vector[], smoothing: number, strategy: 'complex' | 'bezier' | 'simple') => {
